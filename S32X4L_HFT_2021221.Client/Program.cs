...
namespace S32X4L_HFT_2021221.Client
{
    ...
    class Program
    {
        ...
        static void ChangeCourseName()
        {
            ...
            int id = int.Parse(Console.ReadLine());
            var get = rest.Get<Courses>(id, "courses");
        ...
        static void HeldCoursesByTeachers()
        {
            ...
            courses.ForEach(x => Console.WriteLine(x.CNAME + " --- " + x.NAME));
            Console.ReadKey();
        }
        ...
        static void DeleteSubject()
        {
            ...
            var subject = rest.Get<Subjects>(SubjectID, "subjects");
            if (subject == null)
            {
                throw new Exception();
            }
        ...
        static void ChangeSubjectProps()
        {
            ...
            int id = int.Parse(Console.ReadLine());
            var get = rest.Get<Subjects>(id, "subjects");
        ...
        static void ChangeStudentProps()
        {
            ...
            string id = Console.ReadLine();
            var get = rest.Get2<Students>(id, "students");
        ...
        static void StudentsNameSortedByLengthDescByCourses()
        {
            ...
            get.ForEach(x => Console.WriteLine(x.SNAME +" --- " + x.CNAME));
            Console.ReadKey();
        }
        ...
        static void GetEachStudentForEachCoursesbyTeachers()
        {
            ...
            get.ForEach(x => Console.WriteLine(x.NAME + " --- " + x.TNAME));
            Console.ReadKey();
        ...
        static void DeleteTeacher()
        {
            ...
            var teacher = rest.Get<Subjects>(teacherId, "teacher");
            if (teacher == null)
            {
                throw new Exception();
            }
        ...
        static void ChangeTeacherProps()
        {
            ...
            Console.WriteLine("Írja be annak a tanulónak a neptunkódját akinek a nevét át szeretné írni");
            int id = int.Parse(Console.ReadLine());
            var get = rest.Get<Teacher>(id, "teacher");
        ...
        static void Main(string[] args)
        {
           ...
           .Add("Tárgy nevének változtatása.", () => ChangeSubjectProps());
